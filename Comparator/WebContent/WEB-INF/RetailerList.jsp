...
<body>
	...
	<core:if test="${sessionScope.admin}">
		<div id="mainform">
			<div id="popup">
				<form action="DisconnectUser" method="post"
					id="Disconnect">
					<p id="ButtonDisconnect">Disconnect</p>
					<input type="hidden" name="action" value="RetailerManagement">
				</form>
			</div>
		</div>
	</core:if>
	...
	<form action="RetailerDelete" method="post">

		<h1>Table of retailers</h1>
		...
		<table class="TFtable">
			...
			<thead>
				<tr>
					...
					<th><h2>Name</h2></th>
					<th><h2>idRetailer</h2></th>
					<th><h2>Distance</h2></th>
					<core:if test="${sessionScope.admin}">
						<th><h2>Delete</h2></th>
					</core:if>
				</tr>
			...
			<core:forEach var="retailer" items="${listRetailer}"
				varStatus="count">
				<tr>
					<td><core:out value=" ${count.count}" /></td>
					<td><core:out value="${retailer.name}" /></td>
					<td><core:out value="${retailer.idRetailer}" /></td>
					<td><core:out value="${retailer.distance}" /></td>
					<core:if test="${sessionScope.admin}">
						<td><INPUT type="checkbox" name="option"
							value="${retailer.idRetailer}"></td>
...
<core:if test="${sessionScope.admin}">
	<h1>Access to Products Management</h1>
...
<core:out value="${sessionScope.connect}" />
